-- ============================================================
-- Migration: get_own_stats() function (consolidated)
-- Commit: item-6/migration-consolidation
--
-- Source: add_get_own_stats.sql — verbatim, no logic changes.
-- Excludes guest (NULL user_id) downloads from points, matching
-- the same guest-exclusion logic in get_leaderboard().
-- ============================================================
